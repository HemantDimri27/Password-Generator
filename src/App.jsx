...
/*
  useCallBack(fn, [dependenties]) , used to optemized the function(fn) using cache memory 
  
  useEffect(fn, [dependenties]) , used to called fn when effect on deppendenties
*/
